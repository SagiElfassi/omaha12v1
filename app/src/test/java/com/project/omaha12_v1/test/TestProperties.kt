...
class TestProperties {
    companion object {
        ...
        fun `a high card ace`(): Array<PokerCard> {
            return arrayOf(
                aceOfClub, kingOfDiamond, sevenOfClub, eightOfClub, nineOfHeart
            )
        }
        ...
        fun `a pair of aces with low cards`(): Array<PokerCard> {
            return arrayOf(
                aceOfClub, aceOfDiamond, twoOfClub, threeOfClub, fourOfClub
            )
        }

        fun `a pair of aces with high cards`(): Array<PokerCard> {
            return arrayOf(
                aceOfClub, aceOfDiamond, sevenOfClub, eightOfClub, nineOfHeart
            )
        }

        fun `a pair of aces and pair of kings`(): Array<PokerCard> {
            return arrayOf(
                aceOfClub, aceOfDiamond, kingOfClub, kingOfDiamond, nineOfHeart
            )
        }

        fun `a three of a kind aces`(): Array<PokerCard> {
            return arrayOf(
                aceOfClub, aceOfDiamond, aceOfHeart, kingOfDiamond, nineOfHeart
            )
        }

        fun `a stright of 10 high`(): Array<PokerCard> {
            return arrayOf(
                sixOfClub, sevenOfClub, eightOfDiamond, nineOfHeart, tenOfSpade
            )
        }

        fun `a stright of ace high`(): Array<PokerCard> {
            return arrayOf(
                tenOfSpade, jackOfClub, queenOfDiamond, kingOfClub, aceOfSpade
            )
        }

        fun `a stright of five high`(): Array<PokerCard> {
            return arrayOf(
                aceOfSpade, twoOfClub, threeOfClub, fourOfHeart, fiveOfHeart
            )
        }
        ...
        fun `a full house aces and kings`(): Array<PokerCard> {
            return arrayOf(
                aceOfClub, aceOfDiamond, aceOfHeart, kingOfDiamond, kingOfClub
            )
        }

        fun `a four of a king kings`(): Array<PokerCard> {
            return arrayOf(
                kingOfClub, kingOfDiamond, kingOfHeart, kingOfSpade, nineOfClub
            )
        }

        fun `a straight flush of five high`(): Array<PokerCard> {
            return arrayOf(
                aceOfSpade, twoOfSpade, threeOfSpade, fourOfSpade, fiveOfSpade
            )
        }

        fun `a royal flush`(): Array<PokerCard> {
            return arrayOf(
                tenOfSpade, jackOfSpade, queenOfSpade, kingOfSpade, aceOfSpade
            )
        }

        fun `a random omaha hand`(): Array<PokerCard> {
            return arrayOf(
                tenOfSpade, jackOfSpade, queenOfSpade, kingOfSpade
            )
        }
        ...
        fun `omaha hand KhKd5d6d`(): Array<PokerCard> {
            return arrayOf(kingOfHeart, kingOfDiamond, fiveOfDiamond, sixOfDiamond)
        }

        fun `omaha hand Th9d5d6d`(): Array<PokerCard> {
            return arrayOf(tenOfHeart, nineOfDiamond, fiveOfDiamond, sixOfDiamond)
        }

        fun `omaha hand Th9h5d6d`(): Array<PokerCard> {
            return arrayOf(tenOfHeart, nineOfHeart, fiveOfDiamond, sixOfDiamond)
        }

        fun `board of QcJh8h 3h 2c`(): Array<PokerCard> {
            return arrayOf(queenfClub, jackOfHeart, eightOfHeart, threeOfHeart, twoOfClub)
        }

        fun `board of QcQhQd Qs 2c`(): Array<PokerCard> {
            return arrayOf(queenfClub, queenOfSpade, queenOfDiamond, queenOfSpade, twoOfClub)
        }
    }
}